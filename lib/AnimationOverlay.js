...
export const AnimationOverlay = ({ animationOverlayConfig, onOverlayAnimationComplete, renderItem, listLength, }) => {
    ...
    return (<Modal transparent style={{
            position: "absolute",
            top: 0,
            bottom: 0,
            left: 0,
      ...
      <Animated.View style={{
        ...
        <ListItemContainer item={animationOverlayConfig.partnerItem} renderItem={renderItem} index={animationOverlayConfig.startIndex} listLength={listLength}/>
      </Animated.View>
      {/* Target Item */}
      <Animated.View style={{
            position: "absolute",
        ...
        <ListItemContainer item={animationOverlayConfig.item} renderItem={renderItem} index={animationOverlayConfig.operation === "moveUp"
