...
export const AnimationOverlay = ({ animationOverlayConfig, onOverlayAnimationComplete, renderItem, keyExtractor, }) => {
        ...
        if (animationOverlayConfig) {
            ...
            Animated.timing(animation, {
                ...
                if (animationOverlayConfig.operation === "moveUp") {
                    onOverlayAnimationComplete((currentData) => handleMoveUp(currentData, animationOverlayConfig.item, keyExtractor));
                }
                else {
                    onOverlayAnimationComplete((currentData) => handleMoveDown(currentData, animationOverlayConfig.item, keyExtractor));
                }
            });
        }
        else {
